...
import { Box, Button, Container, Typography,  FormControl, Grid, styled } from '@mui/material';
...
const DayHighLowRange = () => {
 ...
 const csvConfig = mkConfig({
  ...
  const fetchData = async () => {
	  ...
	  setIsLoading(true);
    try {
        const response = await axios.get('http://127.0.0.1:9009/get-report7',{
  params: {
...
export default DayHighLowRange;
